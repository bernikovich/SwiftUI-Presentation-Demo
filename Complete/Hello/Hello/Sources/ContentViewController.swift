...
struct ContentViewControllerPreviews: PreviewProvider, UIViewControllerRepresentable {
    
    func makeUIViewController(context: UIViewControllerRepresentableContext<ContentViewControllerPreviews>) -> ContentViewController {
        return ContentViewController()
    }
    
    func updateUIViewController(_ uiViewController: ContentViewController, context: UIViewControllerRepresentableContext<ContentViewControllerPreviews>) {
        
    }
    
    static var previews: some View {
        NavigationView {
            ContentViewControllerPreviews()
        }
    }
